...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // Simulação de envio
    $msg_sucesso = "Obrigado! Sua mensagem foi enviada com sucesso.";
}
?>
<!DOCTYPE html>
<html lang="pt">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
            <a class="nav-link active" href="contactos.php">Contactos</a> </li>
   ...
   <main class="container my-5">
        ...
        <p class="lead text-center mb-5">Tem alguma dúvida? Envie uma mensagem.</p>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form id="contact-form" method="POST" action="contactos.php">
